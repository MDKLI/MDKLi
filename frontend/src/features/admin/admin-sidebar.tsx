...
const adminItems = sidebarData.navGroups.find((g) => g.title === 'Admin')?.items ?? []
      ...
      <Sidebar variant='floating' side='left' collapsible='icon'>
              ...
              <SidebarMenuButton size='lg' asChild>
                <Link to='/admin/dashboard'>
                  ...
                  <div className='grid flex-1 text-left text-sm leading-tight overflow-hidden group-data-[collapsible=icon]:hidden'>
                    ...
                    <span className='truncate text-xs text-muted-foreground whitespace-nowrap'>Admin</span>
                  </div>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
              ...
              {adminItems.map((item) => {
                ...
                return (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild tooltip={item.title} className='h-10 text-base'>
                      <Link to={item.url}>
        ...
        <SidebarFooter>
          <SidebarMenu className='gap-1.5'>
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip='Search' className='h-10 text-base'>
                <Link to='/search'>
          ...
          <SidebarMenu className='gap-1.5'>
            <SidebarMenuItem>
              ...
              >
                ...
                <span className='overflow-hidden whitespace-nowrap group-data-[collapsible=icon]:hidden'>Logout</span>
              </SidebarMenuButton>
            </SidebarMenuItem>
          </SidebarMenu>
        </SidebarFooter>
