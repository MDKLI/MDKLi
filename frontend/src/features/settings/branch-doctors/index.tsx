...
type RawBranch = Omit<Branch, "doctors">;
			...
			onConfirm: async () => {
				...
				try {
					...
					if (result?.data) {
						...
						// Reload
						const profileResult: ProfileApiResult =
							...
							<CardContent>
								{branch.doctors.length === 0 ? (
									<p className="text-muted-foreground text-center py-4">
										No doctors assigned to this branch yet. Invite doctors from
												...
												<div className="flex items-start gap-4">
													...
													<div>
														...
														<div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
															...
															<span>Since {formatDate(doctor.assignedAt)}</span>
														</div>
													</div>
												</div>
