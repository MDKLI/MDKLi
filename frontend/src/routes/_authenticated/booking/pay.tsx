...
import { Calendar, Clock, CreditCard, Lock, MapPin } from "lucide-react";
...
export const Route = createFileRoute("/_authenticated/booking/pay")({
	validateSearch: (search: Record<string, unknown>): PaySearch => ({
		...
		branchName:
			typeof search.branchName === "string" ? search.branchName : undefined,
...
function FakePaymentPage() {
	const { appointmentId, amount, branchName, date, startTime, endTime } =
		useSearch({
