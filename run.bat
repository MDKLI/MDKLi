...
if "%1"=="" (
    ...
    echo   mdkli-build     - Build Docker containers
    echo   mdkli-run       - Start Docker containers
    echo   mdkli-stop      - Stop Docker containers
    echo   mdkli-delete    - Clean up and stop containers
