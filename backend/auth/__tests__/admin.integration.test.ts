...
const mockedAuthenticateJWT = require("../src/middleware/auth.middleware")
	.authenticateJWT as jest.Mock;
const mockedIsAdmin = require("../src/middleware/admin.middleware")
	.isAdmin as jest.Mock;
...
describe("Admin Routes Integration Tests", () => {
	...
	beforeEach(async () => {
		...
		mockedAuthenticateJWT.mockImplementation((req, _res, next) => {
	...
	describe("GET /users", () => {
		...
		it("should return 403 if user is not admin", async () => {
			mockedIsAdmin.mockImplementation((_req, res, _next) => {
				return res.status(403).json({ message: "Forbidden" });
			});
			mockedAuthenticateJWT.mockImplementation((req, _res, next) => {
