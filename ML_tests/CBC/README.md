...
Hierarchical CBC (Complete Blood Count) classification pipeline, served via
FastAPI and deployed on Kubernetes. Part of the MDKLi graduation project.
...
### Setting up the Google Drive service account (needed for `dvc push`/`pull`
### outside your own machine, e.g. in `retrain.yml`)
