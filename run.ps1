...
switch ($Command.ToLower()) {
    ...
    default {
        ...
        Write-Host "  mdkli-build     - Build Docker containers"
        Write-Host "  mdkli-run       - Start Docker containers"
        Write-Host "  mdkli-stop      - Stop Docker containers"
        Write-Host "  mdkli-delete    - Clean up and stop containers"
